...
// This program reads xlsx files and xlsm files, but it does not read xls files.
// The current code is at read/script_reader/script_reader.go
// Retired Jun 8, 2026 GNG
